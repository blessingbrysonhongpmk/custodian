...
export const CustodianMobileView: React.FC<CustodianMobileViewProps> = ({
  ...
  const [myTreesData, setMyTreesData] = useState<CustodianTreeItem[]>([
    {
      ...
      referencePhotoUrl: TREE_IMAGES.palmyra.mature,
      originalPlantationPhotoUrl: TREE_IMAGES.palmyra.sapling,
      isNative: true,
      ...
      verificationTimeline: [
        { stage: "Plantation", title: "Sapling Planting", date: "14 Apr 2024", status: "completed", photoUrl: TREE_IMAGES.palmyra.sapling },
        { stage: "1 Year", title: "Deep Root Anchorage", date: "14 Apr 2025", status: "completed", photoUrl: TREE_IMAGES.palmyra.mature },
    ...
    },
    {
      ...
      referencePhotoUrl: TREE_IMAGES.pongamia.mature,
      originalPlantationPhotoUrl: TREE_IMAGES.pongamia.sapling,
      isNative: true,
      ...
      verificationTimeline: [
        { stage: "Plantation", title: "Sapling Planting", date: "18 Jan 2025", status: "completed", photoUrl: TREE_IMAGES.pongamia.sapling },
        { stage: "1 Month", title: "Establishment Check", date: "18 Feb 2025", status: "completed", photoUrl: TREE_IMAGES.pongamia.sapling },
    ...
    },
    {
      ...
      referencePhotoUrl: TREE_IMAGES.arjuna.mature,
      originalPlantationPhotoUrl: TREE_IMAGES.arjuna.sapling,
      isNative: true,
      growthStage: "Stage 2 (1M-6M)",
      custodyChain: [
      ...
      verificationTimeline: [
        { stage: "Plantation", title: "Sapling Planting", date: "02 Feb 2025", status: "completed", photoUrl: TREE_IMAGES.arjuna.sapling },
        { stage: "1 Month", title: "Root Settlement", date: "02 Mar 2025", status: "completed", photoUrl: TREE_IMAGES.arjuna.sapling },
  ...
  const [friendsTrees, setFriendsTrees] = useState<FriendTreeItem[]>([
    ...
    },
    {
      ...
      referencePhotoUrl: TREE_IMAGES.tamarind.mature,
    },
    {
      id: "F-4",
      treeId: "TN-COL-00084",
    ...
    },
    {
      ...
      referencePhotoUrl: TREE_IMAGES.mahua.mature,
    },
    {
      id: "F-6",
      treeId: "TG-IND-027",
      ...
      referencePhotoUrl: TREE_IMAGES.jamun.mature,
    },
    {
      id: "F-7",
      treeId: "TG-IND-009",
      ...
      referencePhotoUrl: TREE_IMAGES.peepal.mature,
    }
  ]);
  ...
  const handleTriggerVerify = (treeId: string) => {
    ...
    if (existing) {
      ...
      const syntheticTree: Tree = {
        ...
        initialHeightCm: 50,
        currentHeightCm: 85,
        initialPhotoUrl: TREE_IMAGES.arjuna.sapling,
        currentPhotoUrl: TREE_IMAGES.arjuna.mature,
